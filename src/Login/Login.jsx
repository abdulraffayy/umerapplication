...
import { FaLock, FaEye, FaEyeSlash, FaSignInAlt, FaGlobe } from "react-icons/fa";
        ...
        >
            <div className="bg-opacity-70 p-8 rounded-lg w-[90%] shadow-lg bg-transparent">
                <form onSubmit={handleSubmit}>
                    <div className="mb-4 relative">
                        ...
                        <div className="flex items-center border border-white rounded-lg overflow-hidden bg-transparent">
                            <button
                                type="button"
                                className="px-3 py-2 text-white flex items-center gap-2"
                                onClick={() => setIsModalOpen(true)}
                            >
                                <FaGlobe /> {selectedCountry.code}
                            </button>
                            <input
                                type="text"
            ...
            {isModalOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-opacity-50">
                    <div className="bg-white p-4 rounded-lg w-[300px] h-[300px] shadow-lg flex flex-col">
                        <h2 className="text-xl font-semibold mb-2 text-center">Select Country</h2>
